...
TOKEN = os.getenv('8383723404:AAEnlYHXd5ijRDXnprKDtooENGcr8uto74Y') # Prefer .env
if not TOKEN or TOKEN == "8383723404:AAEnlYHXd5ijRDXnprKDtooENGcr8uto74Y": # Check if token is missing or placeholder
