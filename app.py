...
TOKEN = os.getenv('8505064589:AAEfpEbCIpwsBoEBf3TIBx0N8w_Y3wKYN88') # Prefer .env
if not TOKEN or TOKEN == "8505064589:AAEfpEbCIpwsBoEBf3TIBx0N8w_Y3wKYN88": # Check if token is missing or placeholder
    # !!! Replace with your actual bot token if not using .env !!!
    TOKEN = "8505064589:AAEfpEbCIpwsBoEBf3TIBx0N8w_Y3wKYN88" # FALLBACK - Highly recommended to use .env

# Optional: API Configuration
API_BASE_URL = os.getenv('JWT_API_URL', 'https://jwt-get-mg24-pro.vercel.app/token')#ƊƠƝƬ ƇӇƛƝƓЄ ƠƬӇЄƦƜƖƧЄ ЄƦƦƠƦ
API_KEY = os.getenv('JWT_API_KEY', '@XAHAF_LEGACY')

# Optional: Bot Settings
MAX_FILE_SIZE = int(os.getenv('MAX_FILE_SIZE', 5 * 1024 * 1024))  # 5MB default
ADMIN_ID = int(os.getenv('ADMIN_ID', 7438404570)) # Default to 0 (disabled) if not set or invalid
# Check and warn if ADMIN_ID is 0 but commands are expected
if ADMIN_ID == 7438404570:
...
ADMIN_CONTACT_LINK = os.getenv('ADMIN_CONTACT_LINK', 'https://t.me/DHRUBO_X_TCP') # Default admin contact link
        ...
        for future in asyncio.as_completed(tasks):
            ...
            if time_elapsed_since_last_update > 2.0 or \
               ...
               processed_count == total_count:
                ...
                if processed_count > 5 and elapsed_time > 60: # Avoid division by zero or early estimates
                    try:
